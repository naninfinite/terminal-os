  ...
  return (
    ...
    >
      ...
      <Panel
        ...
        stretchBody
        bodyClassName={styles.panelBodyFlush}
        headerActions={renderHeaderActions({ scope: 'third', fullscreenLabel: 'ENTER SCENE LAB', onOpenFullscreen: openThirdFullscreen })}
        enableTouchContextFallback
      ...
      <Panel
        ...
        stretchBody
        bodyClassName={styles.panelBodyFlush}
        headerActions={renderHeaderActions({ scope: 'connect', fullscreenLabel: 'OPEN', onOpenFullscreen: openConnectFullscreen })}
        enableTouchContextFallback
