...
- `ME.EXE` now opens a fullscreen portfolio “window/OS” overlay with a media preview + gallery (images/videos), keyboard navigation, and reduced-motion friendly transitions.
