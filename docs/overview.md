...
- Phase 2 implemented: core behaviors plus a portfolio-focused `ME.EXE` overlay window with media gallery. See `docs/phase-2.md` for details.
...
- `ME.EXE` now opens a fullscreen portfolio “window/OS” overlay with CRT-consistent media preview and gallery, keyboard navigation, and reduced-motion friendly transitions.
